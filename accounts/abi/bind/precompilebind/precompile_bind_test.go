...
func TestPrecompileBind(t *testing.T) {
	...
	pwd, _ := os.Getwd()
	replacer := exec.Command(gocmd, "mod", "edit", "-x", "-require", "github.com/Rinkuby-Labs/subnet-evm@v0.0.0", "-replacegithub.com/Rinkuby-Labs/subnet-evmbnet-evm="+filepath.Join(pwd, "..", "..", "..", "..")) // Repo root
	replacer.Dir = pkg
