...
## [v0.8.1](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.8.1)
...
## [v0.8.0](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.8.0)
...
## [v0.7.9](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.7.9)
...
## [v0.7.8](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.7.8)
...
## [v0.7.7](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.7.7)
...
## [v0.7.6](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.7.6)

_This release should be skipped entirely in favor of 0.7.7 due to the use of a AvalancheGo release candidate version._

## [v0.7.5](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.7.5)
...
## [v0.7.4](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.7.4)
...
## [v0.7.3](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.7.3)
...
**Full Changelog**: <https://github.com/Rinkuby-Labs/subnet-evm/compare/v0.7.2...v0.7.3>

## [v0.7.2](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.7.2)

This version is backwards compatible to [v0.7.0](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.7.0). It is optional, **but strongly encouraged as it's fixing an important bug in uptime tracking.**
...
## [v0.7.1](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.7.1)
...
## [v0.7.0](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.7.0)
...
## [v0.6.11](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.6.11)

This release focuses on Standalone DB and database configs.

This version is backwards compatible to [v0.6.0](https://github.com/Rinkuby-Labs/subnet-evm/releases/tag/v0.6.0). It is optional, but encouraged.
